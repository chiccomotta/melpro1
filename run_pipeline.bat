...
psql -h localhost -U postgres -d targetdb -c "BEGIN; DROP TABLE IF EXISTS public.\"%COPY_TABLE_NAME%\"; CREATE TABLE public.\"%COPY_TABLE_NAME%\" (LIKE public.\"%TABLE_NAME%\" INCLUDING ALL); INSERT INTO public.\"%COPY_TABLE_NAME%\" SELECT * FROM public.\"%TABLE_NAME%\"; COMMIT;"
if %ERRORLEVEL% NEQ 0 (
